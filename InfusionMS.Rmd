...
### Inferences by Masked Autoregressive Flows (MAFs)

MAFs are here computed on the final reference tables only.
...
#### Training times of MAFs

The training times of the MAFs on the final reference tables are shown in the comments of the following code: 
```{r eval=FALSE}
...
```
Timings for "alternative" MAF controls, and for "alternative" controls but with a learning rate of `1e-4`, were 551.63 s and 1244.65 s, respectively (measured on yet another cluster, with more GPU available).
